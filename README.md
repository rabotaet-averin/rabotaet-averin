...
**Общий опыт в IT – 3 года. За это время:**
...
> За все время обработал 20 учебных инцидентов в LetsDefend + overthewire.org/wargames/bandit

---

#### 🛡️ Развёртывание и настройка Secret Net Studio (экзамен в Нетологии)

> Выполнил практический экзамен по развертыванию и настройке СЗИ Secret Net Studio. Отработал установку серверной и клиентской частей, настройку политик безопасности, управление правами доступа, контроль целостности системы, регистрацию событий и аудит защищённости. Результаты экзамена подтверждены сертификатом.

<table>
  <tr>
    <td><img src="images/SNS2.png" width="380" alt="Secret Net Studio настройка 1"></td>
    <td><img src="images/SNS3.png" width="380" alt="Secret Net Studio настройка 2"></td>
  </tr>
  <tr>
    <td align="center"><b>Настройка политик безопасности</b></td>
